...
<nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
    <div class="container-fluid">
        <!-- Brand -->
         <!--<a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('home') }}">{{ __('Playmaker') }}</a>-->
        <!-- Form -->
        ...
        <!-- User -->
        <ul class="navbar-nav align-items-center d-none d-md-flex pl-align-r">
