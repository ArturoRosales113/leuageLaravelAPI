    ...
    <div class="row mt-5">
        <div class="col">
            <div class="card shadow pb-5">
                ...
                <form method="POST" enctype="multipart/form-data" action="{{ route('leagues.store') }}"
                    class="pl-5 pr-5">
                    @csrf
                    <div class="form-group row">
                        <label for="league" class="col-sm-3 col-form-label">Nombre de la liga</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="name" value="{{ old('name') }}" id="league"
                                placeholder="Liga Valle Verde">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea name="description" rows="5" cols="79"
                                placeholder="Escribe la descripción de la liga">{{ old('description') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select class="custom-select" name="sport_id">
                                ...
                                @foreach ($sports as $s)
                                <option {{ old('sport_id')==$s->id ? 'selected' : ''}} value="{{ $s->id }}">{{
