        ...
        <div class="row mt-5">
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('sports.update', $sport->id) }}" class="pl-5 pr-5">
                            @csrf
                            {{ method_field('PUT') }}
                            <div class="form-group row">
                                <label for="Name" class="col-sm-3 col-form-label">Nombre del Deporte</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="name" value="{{ old('name' , $sport->display_name) }}" placeholder="ej. Basketball" >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Description" class="col-sm-3 col-form-label">Descripción</label>
                                <div class="col-sm-9">
                                    <textarea name="description" rows="5" cols="79" placeholder="Escribe la descripción del deporte">{{ old('description', $sport->description) }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
